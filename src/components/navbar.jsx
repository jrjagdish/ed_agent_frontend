        ...
        <>
            ...
            >
                ...
                <div className="hidden lg:block space-x-3">
                    <Link to = "/register"><button className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 transition text-white rounded-md active:scale-95">
                        Start Prepping
                    </button></Link>
                    <Link to = "/login"><button className="hover:bg-slate-300/20 transition px-6 py-2 border border-slate-400 rounded-md active:scale-95 text-white">
                        Login
                    </button></Link>
                </div>
            ...
            <div className={`fixed inset-0 z-[100] bg-black/60 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 lg:hidden transition-transform duration-400 ${isMenuOpen ? "translate-x-0" : "-translate-x-full"} text-white`}>
                {navlinks.map((link) => (
