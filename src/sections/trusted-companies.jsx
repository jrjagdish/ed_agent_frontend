...
export default function TrustedCompanies() {
    return (
        <section className="flex flex-col items-center">
            <SectionTitle title="Interview with confidence" description="Master the interview patterns used by world-class engineering teams to evaluate top-tier talent." />
                ...
                <div className="flex flex-col items-center md:items-start max-md:text-center">
                    <a href="#" className="group flex items-center gap-2 rounded-full text-sm p-1 pr-3 text-indigo-300 bg-indigo-200/15">
                        ...
                        <p className="flex items-center gap-1">
                            <span>Get 5 free AI mock sessions </span>
                    ...
                    <h1 className="text-3xl font-medium max-w-xl mt-5 bg-gradient-to-r from-white to-[#b6abff] text-transparent bg-clip-text">Trusted by candidates globally.</h1>
                    <p className="text-base text-slate-400 max-w-lg mt-4">
                        Our AI is trained on thousands of successful real-world interviews to provide you with the most accurate practice experience possible.
                    </p>
