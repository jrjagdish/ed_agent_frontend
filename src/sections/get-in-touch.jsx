...
            <SectionTitle title="Get in touch" description="Have questions about our AI interview modules or enterprise plans? Reach out to our team for support." />
...
                    <textarea name='message' rows={8} placeholder='How can we help you prep?' className='resize-none w-full mt-2 p-3 outline-none rounded-lg focus-within:ring-1 transition focus:ring-indigo-600 border border-slate-700' />
                </motion.div>
