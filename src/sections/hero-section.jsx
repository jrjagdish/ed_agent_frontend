...
export default function HeroSection() {
    return (
        <section className="flex flex-col items-center -mt-18">
            ...
            <motion.h1 className="text-center text-5xl leading-[68px] md:text-6xl md:leading-[70px] mt-4 font-semibold max-w-2xl text-white"
            ...
            <motion.p className="text-center text-slate-400 text-base max-w-lg mt-2"
                initial={{ y: 50, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Practice with realistic AI-driven mock interviews and get instant feedback to sharpen your skills and land your dream job.
            </motion.p>
