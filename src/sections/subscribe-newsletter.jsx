...
export default function SubscribeNewsletter() {
    return (
        <section className="flex flex-col items-center">
            <SectionTitle title="Weekly interview prep" description="Get AI-curated interview questions, system design deep dives, and career tips sent directly to your inbox." />
            ...
            >
                <input type="text" className="bg-transparent outline-none rounded-full px-4 h-full flex-1 placeholder:text-slate-400 text-white" placeholder="Enter your email address" />
