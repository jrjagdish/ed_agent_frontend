...
export default function OurLatestCreation() {
    ...
    const sectionData = [
        {
            title: "Technical Mocks",
            description: "Practice data structures, algorithms, and system design with an AI that evaluates your logic and code efficiency.",
            image: "https://images.unsplash.com/photo-1543269865-0a740d43b90c?q=80&w=800&h=400&auto=format&fit=crop",
            align: "object-center",
        },
        {
            title: "Behavioral AI",
            description: "Refine your storytelling using the STAR method with AI feedback on your delivery, tone, and leadership signals.",
            image: "https://images.unsplash.com/photo-1714976326351-0ecf0244f0fc?q=80&w=800&h=400&auto=format&fit=crop",
            align: "object-right",
        },
        {
            title: "Real-time Coaching",
            description: "Receive live hints and post-interview analytics to identify exactly where you need to improve to land the offer.",
    ...
    return (
        <section className="flex flex-col items-center" id="creations">
            <SectionTitle
                title="AI Interview Suites"
                description="Choose a specialized module to simulate high-pressure environments and get detailed performance reports."
            />
